...
const CardQuestions = ({ name, title }) => {
    ...
    return(
        <div className="relative flex justify-center items-center flex-col mt-5 w-[505px] bg-[#E4E4E4] rounded-[28px]">
            <div className="bg-[#F4F4F4] rounded-[50px] w-full h-[55px] flex xs:justify-center justify-start pl-5 items-center shadow-[0px_12.5px_10px_-10px_rgba(0,0,0,0.3)] z-[1]">
                <div className="">
            ...
            <div className={`${toggle ? "block" : "hidden"} bg-[#E4E4E4] top-0 z-[0] pt-4 pb-4 sm:px-14 px-5 rounded-b-[28px] shadow-[0px_12.5px_10px_-10px_rgba(0,0,0,0.3)]`}>
                <div className="">
